...
RSpec.describe Legion::Extensions::Agentic::Homeostasis::Tide::Runners::CognitiveTide do
  let(:engine) { Legion::Extensions::Agentic::Homeostasis::Tide::Helpers::TideEngine.new }
  ...
  describe '.check_tide' do
    ...
    it 'returns a valid phase symbol' do
      ...
      expect(Legion::Extensions::Agentic::Homeostasis::Tide::Helpers::Constants::TIDE_PHASES).to include(phase)
    end
    ...
    it 'works with no oscillators (returns 0.0 level)' do
      empty_engine = Legion::Extensions::Agentic::Homeostasis::Tide::Helpers::TideEngine.new
