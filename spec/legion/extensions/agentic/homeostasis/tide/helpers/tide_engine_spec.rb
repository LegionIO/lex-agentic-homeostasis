...
RSpec.describe Legion::Extensions::Agentic::Homeostasis::Tide::Helpers::TideEngine do
  ...
  describe '#add_oscillator' do
    it 'returns an Oscillator instance' do
      osc = add_primary
      expect(osc).to be_a(Legion::Extensions::Agentic::Homeostasis::Tide::Helpers::Oscillator)
    end
  ...
  describe '#current_phase' do
    it 'returns one of the four tide phases' do
      add_primary
      expect(Legion::Extensions::Agentic::Homeostasis::Tide::Helpers::Constants::TIDE_PHASES)
  ...
  describe '#create_pool' do
    it 'creates a pool for a domain' do
      ...
      expect(pool).to be_a(Legion::Extensions::Agentic::Homeostasis::Tide::Helpers::TidalPool)
    ...
    it 'returns nil when MAX_POOLS is reached' do
      max = Legion::Extensions::Agentic::Homeostasis::Tide::Helpers::Constants::MAX_POOLS
  ...
  describe '#tide_forecast' do
    ...
    it 'number of steps is ceil(duration / FORECAST_RESOLUTION)' do
      resolution = Legion::Extensions::Agentic::Homeostasis::Tide::Helpers::Constants::FORECAST_RESOLUTION
      add_primary
